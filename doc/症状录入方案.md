...
疾病对象性由 id,name，icd，confirmChild，necessaryChild，child,diseaseChild,additionChild组成。

id为一个疾病的唯一标志，不可冲突，name为疾病名称，icd为疾病icd，confirmChild为确诊症状，necessaryChild为必备症状，child为其他所有症状,diseaseChild为子疾病，additionChild为附加属性，一般存放检查项。
